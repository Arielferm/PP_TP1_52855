...
[![Java](https://img.shields.io/badge/Java-POO-orange?logo=openjdk)](https://www.java.com/)
[![Maven](https://img.shields.io/badge/Maven-Proyecto-C71A36?logo=apachemaven)](https://maven.apache.org/)
...
## ▶️ Cómo se ejecuta cada versión
...
- 1️⃣ **Ejercicio 1:** crea eventos, los copia con el constructor de copia, muestra sus datos
  y el contador estático de eventos creados.
- 2️⃣ **Ejercicio 2:** agrega estudiantes, salas y actividades; inscribe estudiantes en
  actividades y muestra el resumen completo de cada evento.
- 3️⃣ **Ejercicio 3:** las actividades ahora son `Charla` o `Taller` (herencia). El costo del
...
- 4️⃣ **Ejercicio 4:** mismo programa que el Ejercicio 3, ejecutado con un escenario puntual
